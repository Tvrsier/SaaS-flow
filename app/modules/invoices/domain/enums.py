...
class RegimeFiscale(str, Enum):
    ...
    RF03 = "RF03"  # Agricoltura e attività connesse (art.34 e 34-bis DPR 633/72)
    RF04 = "RF04"  # Vendita sali e tabacchi (art.74, c.1, DPR 633/72)
    RF05 = "RF05"  # Commercio dei fiammiferi (art.74, c.1, DPR 633/72)
    RF06 = "RF06"  # Editoria (art.74, c.1, DPR 633/72)
    RF07 = "RF07"  # Gestione di servizi di telefonia pubblica (art.74, c.1, DPR 633/72)
    RF08 = "RF08"  # Rivendita di documenti di trasporto pubblico (art.74, c.1, DPR 633/72)
    RF09 = "RF09"  # Agenzie di viaggi e turismo (art.74-ter DPR 633/72)
    RF10 = "RF10"  # Agriturismo (art.5, c.2, L.413/91)
    RF11 = "RF11"  # Vendita a domicilio (art.25-bis, c.6, DPR 600/73)
    RF12 = "RF12"  # Rivendita di beni usati, oggetti d'arte, d'antiquariato (art.36-bis DL 41/95)
    RF13 = "RF13"  # Agenzie di vendite all'asta di oggetti d'arte (art.40-bis DL 41/95)
    RF14 = "RF14"  # IVA per cassa (art.32-bis DL 83/2012)
    RF15 = "RF15"  # Regime forfettario (art.1, c.54-89, L.190/2014)
    RF16 = "RF16"  # Regime fiscale IVA per cassa P.A. (art.6, c.5, DPR 633/72)
    RF17 = "RF17"  # Regime forfettario - Minimi (vecchio regime)
    RF18 = "RF18"  # Regime forfettario/Minimi
...
class ModalitaPagamento(str, Enum):
    ...
    MP01 = "MP01"  # Contanti (presso l'esercente)
    MP02 = "MP02"  # Assegno
    MP03 = "MP03"  # Assegno circolare
    MP04 = "MP04"  # Contanti presso Tesoreria (per PA)
    MP05 = "MP05"  # Bonifico
    MP06 = "MP06"  # Vaglia cambiario
    MP07 = "MP07"  # Bollettino bancario
    MP08 = "MP08"  # Carta di pagamento (incluse carta di credito, PayPal, ecc.)
    MP09 = "MP09"  # RID (Rapporti Interbancari Diretti)
    MP10 = "MP10"  # RID veloce
    MP11 = "MP11"  # Riba (Ricevuta bancaria)
    MP12 = "MP12"  # MAV (Mediante Avviso)
    MP13 = "MP13"  # Quietanza erario (stato/enti pubblici)
    MP14 = "MP14"  # Giroconto su conti di contabilità speciale
    MP15 = "MP15"  # Domiciliazione bancaria
    MP16 = "MP16"  # Domiciliazione bancaria
    MP17 = "MP17"  # Domiciliazione postale
    MP18 = "MP18"  # Bollettino di c/c postale
    MP19 = "MP19"  # SEPA Direct Debit (SDD) - FAST
    MP20 = "MP20"  # SEPA Direct Debit (SDD) - B2B
    MP21 = "MP21"  # Tratta
    MP22 = "MP22"  # Tratta telefonica
    MP23 = "MP23"  # Pagamento su PagoPA


class StatoFattura(str, Enum):
    """Stato interno della fattura"""
    DRAFT = "DRAFT"
    READY = "READY"
    ISSUED = "ISSUED"
    CANCELLED = "CANCELLED"
...
# Alias per retrocompatibilità
InvoiceStatus = StatoFattura


class StatoPagamento(str, Enum):
    """Stato del piano/pagamento fattura"""
    PENDING = "PENDING"
    PARTIAL = "PARTIAL"
    PAID = "PAID"
    CANCELLED = "CANCELLED"
